...
<body>
	...
	<div>
                    <br>
                    <br>
                    <form method="GET" class="my-login-validation" action="{{url('footerekleme')}}">
                        <div class="form-group">
                            <label style="margin-left:30px">Footer Hakkımızda</label>
                            <input  style="width:1300px; margin-left:30px" class="form-control" name="dört" value="" >

                        </div>

                         <div class="form-group">
                             <label style="margin-left:30px">Footer Adres</label>
                             <input  style="width:1300px; margin-left:30px" class="form-control" name="bir" value="" >

                         </div>
                         <div class="form-group">
                             <label  style="margin-left:30px">Footer Telefon</label>
                             <input  style="width:1300px; margin-left:30px"  class="form-control" name="iki" value="" >

                         </div>
                         <div class="form-group">
                             <label style="margin-left:30px">Footer Mail</label>
