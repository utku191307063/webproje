...
<body>
	...
	<div>
                    <br>
                    <br>
                    <form method="GET" class="my-login-validation" action="{{url('iletisimekleme')}}">


                         <div class="form-group">
                             <label style="margin-left:30px">Firma Adı:</label>
                         ...
                         <div class="form-group">
                            <label  style="margin-left:30px">Faks:</label>
                            <input  style="width:1300px; margin-left:30px"  class="form-control" name="üc" value="" >

                        </div>
                        <div class="form-group">
                            <label  style="margin-left:30px">Adres:</label>
                            <input  style="width:1300px; margin-left:30px"  class="form-control" name="dört" value="" >

                        </div>
                        <div class="form-group">
                            <label  style="margin-left:30px">E-posta:</label>
                            <input  style="width:1300px; margin-left:30px"  class="form-control" name="bes" value="" >

                        </div>
                        <div class="form-group">
                            <label  style="margin-left:30px">Harita</label>
                            <input  style="width:1300px; margin-left:30px"  class="form-control" name="altı" value="" >

                        </div>

                         <div class="form-group m-0">
                             <button style="margin-left:30px; background-color:orange "type="submit" class="btn btn-primary"   >
                                 İletisim Ekle/Güncelle
                             </button>
                         </div>
