...
@forelse ($kullanıcılar  as $key => $item)
...
<td>{{$item->ad}}</td>
                          ...
                          <td>{{$item->telefon}}</td>
                          <td>{{$item->hesap}}</td>
                          <td><a href="{{url('hesabıdondur/'.$item->id.'/'.$itemi->id)}}">Hesabı Dondur</a></td>
                          <td><a href="{{url('hesabısil/'.$item->id.'/'.$itemi->id)}}">Hesabı sil</a></td>
</tr>
@empty
@endforelse
@empty
...
@forelse ($kullanıcılariki  as $key => $item)
@forelse ($ad  as $key => $itemi)
<tr>
<td>{{$item->ad}}</td>
                          <td>{{$item->soyad}}</td>
                          ...
                          <td>{{$item->telefon}}</td>
                          <td>{{$item->hesap}}</td>
                          <td><a href="{{url('hesabıaktifet/'.$item->id.'/'.$itemi->id)}}">Hesabı aktif et</a></td>
                          <td><a href="{{url('hesabısil/'.$item->id.'/'.$itemi->id)}}">Hesabı sil</a></td>
</tr>
@empty
@endforelse
