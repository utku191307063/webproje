			...
			<div class="row">
				<div class="col-sm-13 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Numaralı Gozlukler</h2>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										...
										<div class="productinfo text-center">
											...
											<a href="{{url('sepetekle/'.$item->id.'/'.$itemiki->id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Sepete Ekle</a>
                                            <a href="{{url('ürünayrıntı/'.$item->id.'/'.$itemiki->id)}}" class="btn btn-default add-to-cart"><i class="fa fa-info-circle"></i>Ürün Ayrıntısı</a>
										</div>
