			...
			<div class="row">
				<div class="col-sm-13 padding-right">
					<div class="features_items"><!--features_items-->
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										...
										<div class="productinfo text-center">
											<img src="{{ asset ('public/images/'.$item->resim)}}" width="50px" height="200px" />
											<h2>{{$item->fiyat}} TL</h2>
											<p>{{$item->ürünadı}}</p>
											<a href="{{url('sepetçıkar/'.$item->id.'/'.$itemiki->id)}}" class="btn btn-default add-to-cart"><i class="fa fa-times"></i>Sepetten çıkar</a>
						...
						<h2>{{$variable2}} TL</h2>
						<a href="{{url('sepetonaylaiki/'.$item->id.'/'.$variable2)}}" style="margin-left:0px; color:orange; font-size:25px;"  >
                                 Sepeti Onayla
						</a>
						<br>
						<br>
