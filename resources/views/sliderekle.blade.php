...
<body>
	...
	<div> @forelse ($ad  as $key => $item)
                    <form method="POST" class="my-login-validation" action="{{url('sliderekleme/'.$item->id)}}" enctype="multipart/form-data">
                         @csrf
                         <div class="form-group">
                             <label style="margin-left:30px" >Başlık 1 </label>
                             <input style="width:1300px; margin-left:30px" class="form-control" name="baslık" value="" >

                         </div>
                         <div class="form-group">
                             <label style="margin-left:30px">Başlık 2</label>
                             <input style="width:1300px; margin-left:30px" class="form-control" name="baslıkiki" value="" >

                         </div>
                         <div class="form-group">
                             <label style="margin-left:30px">Yazı</label>
                             <input style="width:1300px; margin-left:30px" class="form-control" name="yazı" value="" >

                         </div>

                         <div class="form-group">
                             <label style="margin-left:30px" >Slider Resmi</label>
