							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="{{'ürünlerwelcome'}}">Ürünler<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="shop.html">Güneş Gözlükleri</a></li>
										<li><a href="product-details.html">Numaralı Gözlükler</a></li>
										<li><a href="checkout.html">Lensler</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a href="contact-us.html">Hakkımızda</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
