...
<body>
    ...
    <form method="POST" class="my-login-validation" action="{{url('ürüngüncellemeiki/'.$itemi->id.'/'.$item->id)}}" enctype="multipart/form-data">
         @csrf
         <div class="form-group">
             <label style="margin-left:30px" >Ürün Adı </label>
             <input style="width:1300px; margin-left:30px" class="form-control" name="ürünadı" value="{{$item->ürünadı}}" >

         </div>
         <div class="form-group">
             <label style="margin-left:30px">Fiyatı</label>
             <input style="width:1300px; margin-left:30px" class="form-control" name="fiyat" value="{{$item->fiyat}}" >

         </div>
         <div class="form-group">
             <label style="margin-left:30px">Tür</label>
             <input style="width:1300px; margin-left:30px" class="form-control" name="tür" value="{{$item->tür}}" >

         </div>
         <div class="form-group">
             <label style="margin-left:30px">Cinsiyet</label>
             <input style="width:1300px; margin-left:30px" class="form-control" name="cinsiyet" value="{{$item->cinsiyet}}" >

         </div>
         <div class="form-group">
             <label style="margin-left:30px">Malzeme</label>
             <input style="width:1300px; margin-left:30px" class="form-control" name="malzeme" value="{{$item->malzeme}}" >

         </div>
         <div class="form-group">
            <label style="margin-left:30px">Açıklama</label>
            <input style="width:1300px; margin-left:30px" class="form-control" name="acıklama" value="{{$item->açıklama}}" >

        </div>
         <div class="form-group">
             <label style="margin-left:30px" >Ürün Adeti</label>
             <input style="width:1300px; margin-left:30px"  class="form-control" name='adet' value="{{$item->adet}}" >
